...
public class MapIntroduction {
    ...
    public static void introduction() {
        ...
        System.out.println("Is value 1 present ? " + count.containsValue(1)); // Is value 1 present ? false
        System.out.println("Set of keys: " + count.keySet()); // Set of keys: [a, b, c, d, e, f, g]
        System.out.println("Collection of values: " + count.values()); // Collection of values: [5, 3, 3, 3, 3, 2, 3]
        ...
        // Optional Methods
        System.out.println("Add key z and value 1 : " + count.put('z', 1)); // Add key z and value 1 : null
        System.out.println("Remove key z : " + count.remove('z')); // Remove key z : 1
        // count.putAll(Collection);
        // count.clear();

        // Default Methods
        System.out.println("Get h or default 0 : " + count.getOrDefault('h', 0)); // Get h or default 0 : 0
    ...
    public static void sortedMap() {
        ...
        System.out.println("Key values between j and r(excluded) : " + sortedMap.subMap('j', 'r').keySet());
    }
