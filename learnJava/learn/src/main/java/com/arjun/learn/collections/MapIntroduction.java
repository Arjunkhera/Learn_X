...
public class MapIntroduction {
    ...
    public static void introduction() {
        ...
        // Query Operations
        System.out.println("Map size is: " + count.size());
        System.out.println("Is Map empty ? " + count.isEmpty());
        System.out.println("Get value for c : " + count.get('c'));
        System.out.println("Is key c present ? " + count.containsKey('c'));
        System.out.println("Is value 1 present ? " + count.containsValue(1));

        // Modification Operations
        System.out.println("Add key z and value 1 : " + count.put('z', 1));
        System.out.println("Remove key z : " + count.remove('z'));

        // Map Views
        System.out.println("Set of keys: " + count.keySet()); // returns set of keys
        System.out.println("Collection of values: " + count.values()); // returns collection of values
        ...
        // Default Methods
        System.out.println("Get h or default 0 : " + count.getOrDefault('h', 0));
        ...
        System.out.println("Compute if absent : " + count.computeIfAbsent('b', (k) -> "Arjun".length()));
        // Calculate new value from lambda and overwrite if not null, else remove old. First present of old is checked
        System.out.println("Compute if present : " + count.computeIfPresent('c', (k, v) -> "Arjun".length() + v));
        // Calculate new value from lamda and overwrite if not null, else remove old. Operation carried regardless
